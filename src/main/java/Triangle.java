public class Triangle {
    ...
    // region CONSTRUCTORS
    //
    /* make a triangle from 3 random sides and sort the sides */
    public Triangle() {
    ...
    /* make a triangle from 2 given sides and add a random 3rd side */
    ...
    /*
     * make a triangle from 3 given sides (should validate sides make a triangle if
     * time)
     */
    ...
    //
    /*
     * output a context string for the triangle instance (write out the list of
     * sides)
     */
    ...
    /* return an int for the perimeter by adding all three sides */
    ...
    //
    /*
     * knowing the largest side helps the Heron formula as well as consistent
     * display
     */
